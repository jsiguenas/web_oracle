    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="${pageContext.request.contextPath}/site?page=home">
          <img alt="muniph" src="assets/img/PHlogo.png" width="170" height="100">
          </a>
          
        </div>
        <div class="navbar-collapse collapse navbar-right">
          <ul class="nav navbar-nav">
          	<li><a href="${pageContext.request.contextPath}/assets/img/PHlogo.pnge/index.jsp"></a></li>
